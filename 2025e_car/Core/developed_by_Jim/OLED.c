...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	// GPIO_WriteBit(GPIOB, GPIO_Pin_8, (BitAction)BitValue)I
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, (BitAction)BitValue);
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, (BitAction)BitValue);
	/*如果单片机速度过快，可在此添加适量延时，以避免超出I2C通信的最大速度*/
	//...
}
